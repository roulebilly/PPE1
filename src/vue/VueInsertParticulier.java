...
public class VueInsertParticulier extends JPanel implements ActionListener {
	private JLabel lbTitre = new JLabel("Ajout d'un Particulier HEHE : "); 
	...
	public VueInsertParticulier ()
	{
		...
		this.add(new JLabel(""));
		txtCivilite.addItem("Homme");
		txtCivilite.addItem("Femme");
	...
	public void actionPerformed(ActionEvent e) {
		...
		{
			String civilite = txtCivilite.getSelectedItem().toString();
			...
			String date = txtDateNaiss.getText().toString();
			
			Particulier unParticulier = new Particulier(nom, adresse, cp, ville, mail, tel, mdp, civilite, prenom, date);
